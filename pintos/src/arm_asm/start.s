...
*	 by Juan Yescas
*
*	A sample assembly code implementation that shows how to configure interruptions.
*
******************************************************************************/
...
* It is necessary to set up the stack for the SVC mode so the SWI can be handled properly.
*/
    mov r0, #0xD3					// Disabling FIQ, IRQ and setting the IRQ Mode.
    msr cpsr_c, r0
    mov sp, #0x20000         		// Setting the stack for SVC Mode.

/*
* Set stack for the System mode and disable the FIQ and IRQ interrupts.
*
